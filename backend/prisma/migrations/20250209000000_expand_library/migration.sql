-- CreateEnum
CREATE TYPE "EnrichmentProvider" AS ENUM ('SCREEN_SCRAPER', 'PIXELLAB', 'MANUAL');
...
-- CreateEnum
CREATE TYPE "RomAssetSource" AS ENUM ('SCREEN_SCRAPER', 'PIXELLAB', 'USER_UPLOAD', 'MANUAL_ENTRY');
